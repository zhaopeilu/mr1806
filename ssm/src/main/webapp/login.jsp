...
<div id="login">
    ...
    <div class="wrapper">
        ...
        <div  class="login sign-in-htm">
            <form id="llllsssid" class="container offset1 loginform">
                <!-- 猫头鹰控件 -->
                ...
                <div class="pad input-container">
                    <section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" name="loginName" type="text" id="login-username"
                        ...
                        <span class="input input--hideo">
								<input class="input__field input__field--hideo" type="password" id="login-password" name="loginPaw" placeholder="请输入密码" tabindex="2" maxlength="15"/>
        ...
        <div class="login sign-up-htm">
            <form id="registerId"  class="container offset1 loginform">
                <!-- 猫头鹰控件 -->
                    ...
                    <section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="register-username"
                                       autocomplete="off" placeholder="请输入用户名" name="loginName" maxlength="15"/>
                        ...
                        <span class="input input--hideo">
								<input class="input__field input__field--hideo" type="password" id="register-password" name="loginPws" placeholder="请输入密码" maxlength="15"/>
...
<script>
    ...
    function login(){//登录
        ...
        if(flag){
            ...
            //调用后台登录验证的方法
            $.ajax({
                url:'<%=request.getContextPath()%>/login/queryLogin.do',
                data:$("#llllsssid").serialize(),
                dataType:'json',
                type:'post',
                async:false,
    ...
    function register(){
        ...
        if(flag){
            ...
            //注册
            $.ajax({
                url:'<%=request.getContextPath()%>/login/registerSub.do',
